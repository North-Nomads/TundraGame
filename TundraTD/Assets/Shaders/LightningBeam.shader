...
////// Emissive:
                ...
                float node_3040 = abs(sin(node_2916.g));
                float4 _Color_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Color );
                float3 emissive = (pow(1.0-max(0,dot(normalDirection, viewDirection)),lerp(0.7,0.99,node_3040))+(_Color_var.rgb*_PatternTexture_var.rgb));
